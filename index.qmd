...
After reading the documentation, the key differences between the 2 languages when creating decision trees is that R natively treats categorical variables as factors, while python does not. This is why the output tree and feature importance differs between the two languages.
